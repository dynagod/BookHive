...
const CheckoutPage = () => {
  ...
  const {
    ...
    defaultValues: {
      ...
      address: currentUserData?.address?.street || "",
                  ...
                  <div className="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
                    ...
                    <div className="md:col-span-5">
                      ...
                      <input
                        ...
                        name="email"
                        id="email"
                        className="h-10 border mt-1 rounded px-4 w-full bg-gray-200 cursor-not-allowed"
                        disabled
                    ...
                    <div className="md:col-span-5 text-right">
                      <div className="inline-flex items-end">
                        <button
                          type="submit"
                          disabled={!isChecked || !cartItems.length}
                          className={`font-bold py-2 px-4 rounded transition-colors ${
                            (isChecked && cartItems.length)
