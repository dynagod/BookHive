...
const Banner = () => {
  return (
    <div className='bg-[#0a0a0a] flex flex-col md:flex-row-reverse px-16 text-white pb-16 justify-between items-center gap-12'>
        ...
        <div className='md:w-1/2 w-full'>
            ...
            <button className='btn-primary text-black'>Subscribe</button>
        </div>
