...
const About = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-amber-50 to-white">
      {/* Hero Section */}
      <section className="relative py-20 px-4 bg-amber-700 text-white overflow-hidden">
        <div className="max-w-4xl mx-auto relative z-10">
          <div className="absolute top-0 left-0 w-full h-full opacity-10">
            <div className="absolute transform rotate-12 -left-10 -top-10 w-32 h-32 bg-white rounded-lg"></div>
            <div className="absolute transform rotate-45 right-20 top-40 w-20 h-20 bg-white rounded-lg"></div>
            <div className="absolute transform -rotate-12 left-1/3 bottom-5 w-24 h-24 bg-white rounded-lg"></div>
          </div>
      ...
      <div className="max-w-5xl mx-auto px-4 py-12">
        ...
        <section className="mb-16">
          <div className="bg-white p-8 rounded-lg shadow-lg transform -mt-20 relative z-20">
        ...
        <section className="mb-16">
          ...
          <div className="mb-8">
            <div className="flex overflow-x-auto pb-2 hide-scrollbar space-x-2">
              {categories.map((category, index) => (
                <button
                  key={index}
                  className={`px-4 py-3 rounded-lg whitespace-nowrap flex-shrink-0 transition-all duration-200 ${
          ...
          <div className="bg-white rounded-lg shadow-md p-8 transition-all duration-300">
            <div className="flex items-start">
              <div className="mr-6 text-amber-600">
        ...
        <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {teamMembers.map((member, index) => (
              <div 
                key={index} 
                className="bg-white p-6 rounded-lg shadow-md border-t-4 border-amber-500 hover:shadow-lg transition-shadow duration-300"
              >
                <div className="w-12 h-12 bg-amber-100 rounded-full flex items-center justify-center mb-4 text-amber-700 font-bold text-xl">
